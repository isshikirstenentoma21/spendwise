...
class ExpenseExportReport {
  const ExpenseExportReport({required this.fileName, required this.content});

  final String fileName;
  final String content;
}

ExpenseExportReport buildCurrentMonthExpenseReport() {
  ...
  return ExpenseExportReport(
    fileName: 'spendwise_$fileMonth.txt',
